...
export default function PrivacyPolicy() {
  return (
    <div className="text-page">
      <h1>Privacy Policy for garner</h1>

      <p>
        At Garner, accessible from garner.app, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that are collected and recorded by Garner and how we use it.
      </p>

      <p>
        If you have additional questions or require more information about our
        Privacy Policy, do not hesitate to <Link to="/contact">contact us</Link>
        .
      </p>
      ...
      <p>
        ...
        shared and/or collect in Garner. This policy is not applicable to any
      ...
      <p>
        If you <Link to="/contact">contact us</Link> directly, we may receive
        additional information about you such as your name, email address, the
      ...
      <p>
        Garner follows a standard procedure of using log files. These files log
      ...
      <p>
        Garner's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Garner does not knowingly collect any Personal Identifiable Information
      ...
      <h3>
        Made with help from{" "}
        <Link
          to={"//www.privacypolicygenerator.info/"}
          target="_blank"
          aria-label="Privacy policy generator"
          rel="noreferrer"
        >
