...
export default function TermsAndConditions() {
  return (
    <div className="text-page">
      ...
      <p>Welcome to garner!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of garner's Website, located at garner.app.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use garner if you do not agree to take
      ...
      <p>
        Unless otherwise stated, garner and/or its licensors own the
        intellectual property rights for all material on garner. All
        intellectual property rights are reserved. You may access this from
        garner for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from garner</li>
        <li>Sell, rent or sub-license material from garner</li>
        <li>Reproduce, duplicate or copy material from garner</li>
        <li>Redistribute content from garner</li>
      </ul>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        garner does not filter, edit, publish, or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of garner, its agents, and/or affiliates. Comments reflect the views and
        opinions of the person who posts their views and opinions. To the extent
        permitted by applicable laws, garner shall not be liable for the
      ...
      <p>
        garner reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant garner a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of garner, and (d) the link is in
      ...
      <p>
        ...
        e-mail to garner. Please include your name, your organization name,
        ...
        our site to which you would like to link. Wait up to 3 weeks for a
        response.
      </p>
      ...
      <p>
        No use of garner's logo or other artwork will be allowed for linking
      ...
      <p>
        ...
        you are free to <Link to="/contact">contact</Link> and inform us at any
      ...
      <h3>
        Made with help from{" "}
        <Link
          to={"//www.termsandconditionsgenerator.com/"}
          target="_blank"
          aria-label="Terms and conditions generator"
          rel="noreferrer"
        >
